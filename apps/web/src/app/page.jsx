...
export default function HomePage() {
  ...
  const { data: criminalsData } = useQuery({
    queryKey: ['criminals-stats'],
    queryFn: async () => {
      const response = await fetch('/api/criminals?limit=10');
  ...
  const { data: reportsData } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch('/api/crime-reports?limit=10');
  ...
  const stats = [
    {
      ...
      value: criminalsData?.criminals?.length || 0,
      change: '+12%',
      color: 'text-red-600',
      bgColor: 'bg-red-50',
      ...
      <div className="relative bg-black text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white bg-opacity-10 rounded-full mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <nav className="space-y-2">
                ...
                <a href="/criminals" className="block text-gray-300 hover:text-white transition-colors">
                  Criminal Database
                </a>
